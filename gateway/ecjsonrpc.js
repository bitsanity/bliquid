...
// client and service exchange stringified versions of these message objects
// over the websocket
//
// msghex : stringified object encrypted with ecies to a Buffer then converted
//          to hex string
...
// a service automatically returns a clone of this whenever something connects
//
...
//
// the error.message field should be ecies-encrypted and encoded as hex
...
//
// confirm object provided is some kind of valid JSON-RPC 2.0 object
//
